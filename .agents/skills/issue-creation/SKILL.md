...
| **Agent / Client** | Dropdown: Codex, OpenCode, Gemini CLI, Cursor, Windsurf, Codex, Other |
...
### Problem Description
The setup script only configures Codex, Gemini CLI, and OpenCode. Codex users have to manually copy skills.
