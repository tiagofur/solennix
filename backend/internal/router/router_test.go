...
func TestNewRouter(t *testing.T) {
	...
	h := New(&handlers.AuthHandler{}, &handlers.CRUDHandler{}, &handlers.SubscriptionHandler{}, &handlers.SearchHandler{}, &handlers.EventPaymentHandler{}, authService, []string{"http://allowed.com"})
