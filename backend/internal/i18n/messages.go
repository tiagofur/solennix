...
var catalogs = map[string]map[string]string{
	"es": {
		...
		"auth.password_strength":                     "La contrasena debe tener al menos 8 caracteres e incluir mayusculas, minusculas, un digito y un simbolo",
		"auth.password_max_length":                   "La contrasena no debe exceder 128 caracteres",
		"auth.password_breached":                     "Esta contrasena aparece en filtraciones conocidas. Elige una diferente",
	...
	"en": {
		...
		"auth.password_strength":                     "Password must be at least 8 characters and contain at least one uppercase letter, one lowercase letter, one digit, and one symbol",
		"auth.password_max_length":                   "Password must not exceed 128 characters",
		"auth.password_breached":                     "This password appears in known data breaches. Choose a different one",
