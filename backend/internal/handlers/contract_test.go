...
func TestOpenAPISpec_OperationalEndpointsContract(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "upload presign endpoint", fragment: "/api/uploads/presign:"},
		{name: "upload complete endpoint", fragment: "/api/uploads/complete:"},
		...
		{name: "upload presign operation", fragment: "operationId: presignImageUpload"},
		{name: "upload complete operation", fragment: "operationId: completePresignedUpload"},
		...
		{name: "upload presign response schema", fragment: "UploadPresignResponse:"},
		{name: "upload complete request schema", fragment: "UploadCompleteRequest:"},
