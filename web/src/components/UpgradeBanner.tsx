...
export const UpgradeBanner: React.FC<UpgradeBannerProps> = ({ 
  ...
  if (type === 'limit-reached') {
    return (
      <div className={`bg-card rounded-md shadow-md border border-error/20 overflow-hidden relative ${className}`}>
        ...
        <div className="relative p-8 flex flex-col items-center text-center">
            ...
            <div className="bg-surface-alt rounded-md p-4 w-full max-w-sm mb-8 border border-border">
            ...
            <Link
                to="/pricing"
                className="inline-flex items-center justify-center px-8 py-3.5 border border-transparent text-base font-bold rounded-md text-white bg-primary hover:bg-primary-dark shadow-md transition-all hover:scale-105"
  ...
  return (
    <div className={`bg-primary/10 rounded-md p-6 border border-primary/20 flex flex-col sm:flex-row items-center justify-between gap-6 ${className}`}>
        ...
        <Link
            to="/pricing"
            className="shrink-0 inline-flex items-center justify-center px-6 py-2.5 border border-transparent text-sm font-bold rounded-md text-white bg-primary hover:bg-primary-dark shadow-sm transition-colors"
