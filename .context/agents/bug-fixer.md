...
- [`src/services/inventoryService.ts`](../src/services/inventoryService.ts)
- [`src/services/eventService.ts`](../src/services/eventService.ts)
- [`src/services/clientService.ts`](../src/services/clientService.ts)
...
- `Database` (interface) - supabase.ts:9
