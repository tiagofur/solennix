      ...
      >
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            Al usar Solennix, aceptas estos t&#xE9;rminos. Solennix es una
            plataforma SaaS para organizadores de eventos. Te otorgamos una
            licencia limitada, no exclusiva y no transferible para usar el
            servicio seg&#xFA;n tu plan de suscripci&#xF3;n activo.{"\n\n"}
            Te comprometes a:{"\n\n"}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            Solennix ofrece planes de suscripci&#xF3;n mensual. Los cobros se
            realizan a trav&#xE9;s de la App Store de Apple o Google Play,
            seg&#xFA;n corresponda.{"\n\n"}
            &#x2022; El plan B&#xE1;sico es gratuito con funcionalidades
            limitadas{"\n"}
            &#x2022; El plan Pro incluye todas las funcionalidades sin
            restricciones{"\n"}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            ...
            configuraci&#xF3;n de tu cuenta en la App Store o Google Play. La
            cancelaci&#xF3;n ser&#xE1; efectiva al final del per&#xED;odo de
            facturaci&#xF3;n actual.{"\n\n"}
            Al cancelar:{"\n\n"}
            &#x2022; Mantendr&#xE1;s acceso hasta el final del per&#xED;odo
            pagado{"\n"}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            Solennix y su contenido son propiedad de Creapolis.Dev. Los datos
            que introduces en la aplicaci&#xF3;n (clientes, eventos, productos)
            son de tu propiedad. Nos otorgas una licencia para almacenarlos y
            procesarlos &#xFA;nicamente con el fin de prestarte el servicio.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            Nos esforzamos por mantener Solennix disponible 24/7, pero no
            garantizamos disponibilidad ininterrumpida. Podemos realizar
            mantenimientos programados con previo aviso. No somos responsables
            por interrupciones causadas por factores externos.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            Solennix se proporciona "tal cual". En la m&#xE1;xima medida
            permitida por la ley aplicable:{"\n\n"}
            &#x2022; No garantizamos que el servicio sea libre de errores{"\n"}
            &#x2022; No somos responsables de p&#xE9;rdidas de datos por causas
            ajenas a nosotros{"\n"}
            &#x2022; Nuestra responsabilidad total no superar&#xE1; el monto
            pagado en los &#xFA;ltimos 3 meses de servicio{"\n"}
            &#x2022; No somos responsables de da&#xF1;os indirectos o
            consecuentes
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            ...
            notificaremos con al menos 15 d&#xED;as de anticipaci&#xF3;n sobre
            cambios materiales. El uso continuado del servicio tras los cambios
            implica aceptaci&#xF3;n.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.body}>
            ...
            disputa se resolver&#xE1; en los tribunales competentes de la Ciudad
            de M&#xE9;xico.
          </Text>
        </View>
